...
Observe the laws concerning the cryptography use before downloading and installing SSL, there are regions in the world where cryptography software is forbidden. The author of this text is not responsible for anyone breaking such laws. Check with a lawyer which are your rights and restrictions before doing anything concerning cryptography.
